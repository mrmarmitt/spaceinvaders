...
bool SpaceInvadersForge::Init()
{
    // vsync ligado por default (o framework vem com OFF — medimos
    // ~5700 fps de render na iGPU, GPU queimando a toa; degrau 4).
...
bool SpaceInvadersForge::Load(ReloadDesc* pReloadDesc)
{
...
void SpaceInvadersForge::Unload(ReloadDesc* pReloadDesc)
{
...
void SpaceInvadersForge::Update(float deltaTime)
{
...
void SpaceInvadersForge::Draw()
{
    ...
    // abre o lote do batcher e publica o alvo nas duas pontes; a cena
    // desenha durante o frame() (drawSprite acumula, drawText da flush
    // no pendente) e o flush final apanha a cauda sem texto.
...
const char* SpaceInvadersForge::GetName() { return "SpaceInvadersForge"; }

bool SpaceInvadersForge::addSwapChain()
{
